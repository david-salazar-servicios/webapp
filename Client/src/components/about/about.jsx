                        ...
                        <div className="container px-5 my-5">
                            <div className="row gx-5 align-items-center">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <p className="lead fw-normal text-muted mb-0">
                                        Nuestra misión es salvaguardar y optimizar el uso del recurso hídrico en cada proyecto que emprendemos, garantizando soluciones sostenibles y eficientes. Resolvemos emergencias residenciales y comerciales relacionadas con el agua, garantizando un suministro y manejo adecuados. Implementamos tecnologías avanzadas y prácticas responsables para conservar el agua y promover el bienestar comunitario.<br /><br />
